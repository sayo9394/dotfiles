...
export PATH=$PATH:/home/simon/.config/emacs/bin
# export PATH=$PATH:/opt/Qt5.11.3/5.11.3/gcc_64/bin
...
plugins=(git zsh-syntax-highlighting zsh-autosuggestions web-search fzf-zsh-plugin)

source $ZSH/oh-my-zsh.sh

# User configuration
# To get Qt applications to work on WSL2
